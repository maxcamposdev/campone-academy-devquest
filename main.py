...
def entrar_etapa_6():
    while True:
        ...
        if escolha == "1":
            print()
            print("Os escudos de defesa ainda estão sendo preparados.")
            ...
            print()
            print("Laboratório de Falhas da etapa 06 será criado depois do roteiro.")
            input("Pressione Enter para voltar...")
        elif escolha == "5":
            print()
            print("Missão em Produção da etapa 06 será criada depois do roteiro.")
            input("Pressione Enter para voltar...")
        elif escolha == "6":
            print()
            print("Prova de Domínio da etapa 06 ainda não será criada.")
